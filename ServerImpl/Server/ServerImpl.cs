...
namespace Server
{
    public class ServerImpl : IServer
    {
        ...
        public ServerImpl(IMedTrainDBContext db)
        {
            ...
            _userUniqueInt = Users.USER_UNIQUE_INT;
        ...
        public void setDB()
        {
            ...
            Question q1 = new Question
            {
                ...
                subjectName = chestXRays.SubjectId,
                normal = true,
                text = "",
                level = Levels.DEFAULT_LVL,
                diagnoses = new List<Topic>() { cxrNormal },
                timesAnswered = 0,
                timesAnsweredCorrectly = 0,
                timeAdded = DateTime.Now,
                images = new List<Image>()
            };
            Image i1_1 = new Image
            {
                ImageId = "../Images/q1_2_lat.jpg",
                QuestionId = _questionID,
            };
            Image i1_2 = new Image
            {
            ...
            Image i2_1 = new Image
            {
                ImageId = "../Images/q2_17_Lat.png",
                QuestionId = _questionID,
            };
            Image i2_2 = new Image
            {
            ...
            Image i3_1 = new Image
            {
                ImageId = "../Images/q3_19_Lat.png",
                QuestionId = _questionID,
            };
            Image i3_2 = new Image
            {
                ImageId = "../Images/q3_19_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q3.images.Add(i3_1);
            ...
            Image i4_1 = new Image
            {
                ImageId = "../Images/q4_20_Lat.png",
                QuestionId = _questionID,
            };
            Image i4_2 = new Image
            {
                ImageId = "../Images/q4_20_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q4.images.Add(i4_1);
            ...
            Image i5_1 = new Image
            {
                ImageId = "../Images/q5_21_Lat.png",
                QuestionId = _questionID,
            };
            Image i5_2 = new Image
            {
                ImageId = "../Images/q5_21_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q5.images.Add(i5_1);
            ...
            Image i6_1 = new Image
            {
                ImageId = "../Images/q6_24_Lat.png",
                QuestionId = _questionID,
            };
            Image i6_2 = new Image
            {
                ImageId = "../Images/q6_24_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q6.images.Add(i6_1);
            ...
            Image i7_1 = new Image
            {
                ImageId = "../Images/q7_30_Lat.png",
                QuestionId = _questionID,
            };
            Image i7_2 = new Image
            {
                ImageId = "../Images/q7_30_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q7.images.Add(i7_1);
            ...
            Image i8_1 = new Image
            {
                ImageId = "../Images/q8_35_Lat.png",
                QuestionId = _questionID,
            };
            Image i8_2 = new Image
            {
                ImageId = "../Images/q8_35_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q8.images.Add(i8_1);
            ...
            Image i9_1 = new Image
            {
                ImageId = "../Images/q9_37_Lat.png",
                QuestionId = _questionID,
            };
            Image i9_2 = new Image
            {
                ImageId = "../Images/q9_37_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q9.images.Add(i9_1);
            ...
            Image i10_1 = new Image
            {
                ImageId = "../Images/q10_38_Lat.png",
                QuestionId = _questionID,
            };
            Image i10_2 = new Image
            {
                ImageId = "../Images/q10_38_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q10.images.Add(i10_1);
            q10.images.Add(i10_2);
            _db.addQuestion(q10);
            #endregion
            #endregion
            ...
            Question q11 = new Question
            {
                ...
                text = "",
                level = Levels.DEFAULT_LVL,
                diagnoses = new List<Topic>() { cxrCavitaryLesion },
                timesAnswered = 0,
                timesAnsweredCorrectly = 0,
                timeAdded = DateTime.Now,
                images = new List<Image>()
            };
            Image i11_1 = new Image
            {
                ImageId = "../Images/q11_9_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q11.images.Add(i11_1);
            _db.addQuestion(q11);
            #endregion
            #region q12
            ...
            Image i12_1 = new Image
            {
                ImageId = "../Images/q12_10_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q12.images.Add(i12_1);
            _db.addQuestion(q12);
            #endregion
            #region q13
            ...
            Image i13_1 = new Image
            {
                ImageId = "../Images/q13_26_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q13.images.Add(i13_1);
            _db.addQuestion(q13);
            #endregion
            #region q14
            ...
            Image i14_1 = new Image
            {
                ImageId = "../Images/q14_39_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q14.images.Add(i14_1);
            _db.addQuestion(q14);
            #endregion
            #endregion
            ...
            Question q15 = new Question
            {
                ...
                text = "",
                level = Levels.DEFAULT_LVL,
                diagnoses = new List<Topic>() { cxrInterstitialOpacities },
                timesAnswered = 0,
                timesAnsweredCorrectly = 0,
                timeAdded = DateTime.Now,
                images = new List<Image>()
            ...
            {
                ImageId = "../Images/q15_34_Lat.png",
                QuestionId = _questionID,
            };
            Image i15_2 = new Image
            {
                ImageId = "../Images/q15_34_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q15.images.Add(i15_1);
            q15.images.Add(i15_2);
            _db.addQuestion(q15);
            #endregion
            #region q16
            ...
            Image i16_1 = new Image
            {
                ImageId = "../Images/q16_42_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q16.images.Add(i16_1);
            _db.addQuestion(q16);
            #endregion
            #region q17
            ...
            Image i17_1 = new Image
            {
                ImageId = "../Images/q17_43_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q17.images.Add(i17_1);
            _db.addQuestion(q17);
            #endregion
            #region q18
            ...
            Image i18_1 = new Image
            {
                ImageId = "../Images/q18_49_PA.png",
                QuestionId = _questionID,
            };
            _questionID++;
            q18.images.Add(i18_1);
            _db.addQuestion(q18);
            #endregion
            #endregion
            /*
