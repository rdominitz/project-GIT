...
namespace ServerLogicTests
{
    ...
    public class GetAutoGeneratedTest
    {
        ...
        [TestMethod]
        public void getAutoGeneratedTestALotOfNormalQuestions()
        {
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            ...
            for (int i = 0; i < 50; i++)
            {
                _server.answerAQuestion(Users.USER_UNIQUE_INT, 1, false, 8, new List<string>() { "topic" }, new List<int>() { 7 }, false);
                _server.answerAQuestion(Users.USER_UNIQUE_INT, 2, false, 8, new List<string>() { "topic" }, new List<int>() { 7 }, false);
            }
            Assert.IsTrue(_server.getAutoGeneratedTest(Users.USER_UNIQUE_INT, "subject", new List<string>() { "topic" }, 10, false).Equals(Replies.SUCCESS));
        }

        [TestMethod]
        public void getAutoGeneratedTestALotOfAbnormalQuestions()
        {
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            _server.createQuestion(Users.USER_UNIQUE_INT, "subject", new List<string>() { "Normal" }, new List<byte[]>(), "");
            ...
            for (int i = 0; i < 50; i++)
            {
                _server.answerAQuestion(Users.USER_UNIQUE_INT, 8, false, 8, new List<string>() { "topic" }, new List<int>() { 7 }, false);
                _server.answerAQuestion(Users.USER_UNIQUE_INT, 9, false, 8, new List<string>() { "topic" }, new List<int>() { 7 }, false);
                _server.answerAQuestion(Users.USER_UNIQUE_INT, 10, false, 8, new List<string>() { "topic" }, new List<int>() { 7 }, false);
            } 
            Assert.IsTrue(_server.getAutoGeneratedTest(Users.USER_UNIQUE_INT, "subject", new List<string>() { "topic" }, 10, false).Equals(Replies.SUCCESS));
        }
    }
